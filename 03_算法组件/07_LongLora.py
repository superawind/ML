...
# LongLora 最大的修改是在 该函数下的shift函数，在torch.matmuk(q, k.transpose(1, 2)) 之前
# 具体的使用，就是将 Attention 中的forward 替换为下面的函数就行，但是它使用的方法十分优雅，用函数 replace_llama_attn 直接在模型加载前修改forward 方法
def forward_noflashattn(
    ...
    # shift LongLora 最大的修改，也是唯一的一处修改
